...
- `RedisTaskAdapter` — stores tasks as msgpack-encoded binary strings,
...
# ---------------------------------------------------------------------------
# RedisTaskAdapter  (plain Redis: binary strings)
# ---------------------------------------------------------------------------


class RedisTaskAdapter(SharedTaskAdapterMixin):
    """
